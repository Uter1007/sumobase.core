...
import {AccountRepository} from '../../account/logic/account.repository';

import {mochaAsync} from '../../../commons/testing/mocha/asyncAwait';

import {Response} from 'express';
import {AuthController, ITokenRequest} from '../controllers/session.controller';
import {SessionService} from '../logic/session.service';

import * as request from 'supertest';
import app from '../../../app';

import {accountModel, AccountState} from '../../account/models/account.model';
import {UserService} from '../../user/logic/user.service';
import {userModel, UserRole, UserState} from '../../user/models/user.model';
...
describe('Auth Controller Tests @UnitTests @session', () => {
    let sessionService;
    let sessMock;
    let resMock;
    let nextMock;
    ...
    it('generateRefreshToken @UnitTests @session', mochaAsync(async () => {
        sessMock
            .expects('createAsync')
            .once()
            .returns();
