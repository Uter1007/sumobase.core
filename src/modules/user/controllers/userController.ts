...
import {userModel, UserRole, UserState, IUserModel} from '../models/userModel';
import {accountModel, AccountState, IAccountModel} from '../../account/models/accountModel';
import {actionEmailModel, IActionEmailModel, ActionEmailState, ActionEmailType} from '../models/actionEmailModel';
import {UserService} from '../logic/userService';
import {AccountService} from '../../account/logic/accountService';
import {ActionEmailService} from '../logic/actionEmailService';
import {LogLevel} from '../../../commons/logger/logModel';
import {
    RegisterParametersNotValid, AccountCheckInvalid, ConfirmationTokenNotValid, ConfirmationTokenExpired
} from '../../errors/models/userMgmtExceptions';
import {BaseController} from '../../../commons/base/baseController';
import * as Promise from 'bluebird';
import {MailFacade} from '../../mail/logic/mailFacade';
