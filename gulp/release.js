...
gulp.task('release', 'Bumps package version, tags release & ' +
          'pushes the current branch to the origin repo', ['commit'], () => {
    ...
    options: {
        'version [minor]': 'The semantic version type for this release [patch|minor|major]. ' +
        'See http://semver.org/ for information.'
    }
});
